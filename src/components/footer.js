      ...
      <Container sx={styles.container}>
        <Flex sx={styles.content}>
          ...
          <Box>
            ...
            <Box onClick={() => { window.open('tel:05308464761') }} sx={{ ':hover': { cursor: 'pointer' }, color: 'white', display: 'flex', textAlign: 'center', justifyContent: 'center', alignItems: 'center' }}><ImPhone color='white' fontSize="1.2em" style={{ marginRight: '8px' }} /> 530 846 47 61</Box>
            <a href='mailto:info@marmarakizogrenciyurdu.com' sx={{ color: 'white', display: 'flex', textAlign: 'center', justifyContent: 'center', alignItems: 'center', mt: 3, textDecoration: 'none' }} onClick={() => {

            }}>info@marmarakizogrenciyurdu.com</a>
          </Box>
