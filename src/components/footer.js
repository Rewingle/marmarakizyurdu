...
<g id="Page-1" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd" color='white'>
      ...
      <Container sx={styles.container}>
        <Flex sx={styles.content}>
          ...
          <Box>
            ...
            <Box sx={{ color: 'white',display:'flex',textAlign:'center',justifyContent:'center',alignItems:'center' }}><ImPhone color='white' fontSize="1.2em" style={{marginRight:'8px'}}/> 530 346 47 61</Box>
          </Box>
